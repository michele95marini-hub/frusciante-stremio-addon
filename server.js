...
// Funzione per assicurare che il catalogo sia mischiato
...
// -----------------------------------------------------------
// 🎯 CORREZIONI CRITICHE PER TIZEN/SMART TV
// -----------------------------------------------------------

// 1. HEADER CORS ESPLICITI
app.use((req, res, next) => {
  res.setHeader('Access-Control-Allow-Origin', '*');
  res.setHeader('Access-Control-Allow-Methods', 'GET, OPTIONS');
  res.setHeader('Access-Control-Allow-Headers', 'Content-Type');
  // Content-Type esatto richiesto da Tizen
...
function getPage(array, skip) {
  ...
  // Aggiunge un URL di poster se non presente nel tuo JSON
